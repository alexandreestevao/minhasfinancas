package com.alexandreestevao.minhasfinancas.api.resources;
...
import com.alexandreestevao.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.alexandreestevao.minhasfinancas.api.dto.LancamentoDTO;
...
public class LancamentoResource {
	...
	public ResponseEntity atualizarStatus(@PathVariable Long id, @RequestBody AtualizaStatusDTO dto) {
		return service.obterPorId(id).map(entity -> {
			...
			if(statusSelecionado == null) {
				return ResponseEntity.badRequest().body("Não foi possível atualizar o status.");
			}
			try {
	...
	public ResponseEntity deletar(@PathVariable Long id) {
		...
		}).orElseGet(() -> new ResponseEntity("Lançamento não encontrato na base de dados.", HttpStatus.BAD_REQUEST));
	}
